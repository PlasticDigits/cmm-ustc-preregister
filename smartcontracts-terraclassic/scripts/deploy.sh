...
echo ""
echo "terrad tx wasm instantiate <code-id> '{\"owner\":\"$OWNER\"}' --from <your-key> --admin \"\" --chain-id $CHAIN_ID --gas auto --gas-adjustment 1.3 --node $RPC_URL --broadcast-mode block -y --label \"ustc-preregister\""
echo ""
